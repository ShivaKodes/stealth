...
const About=()=>{
    return(
        <div className="w-full bg-gradient-to-tl py-10 px-5 from-white  via-white to-champagne grid grid-cols-1 md:grid-cols-2 rounded-lg mb-5 gap-x-5 drop-shadow-lg" id="about">
